from HttpTrigger4 import switchlighton
import logging
...
def main(req: func.HttpRequest) -> func.HttpResponse:
    ...
    CONNECTION_STRING = "HostName=smart-irrigation.azure-devices.net;SharedAccessKeyName=iothubowner;SharedAccessKey=xxxxxxxxxxxxxxxxxxx"
    ...
    if name=="lightoff":
        x=switchlightoff(CONNECTION_STRING,DEVICE_ID)
        y=str(x) 
...
def switchlightoff(CONNECTION_STRING,DEVICE_ID):
    #choose manually either to start or stop watering
    #start watering
    METHOD_NAME = "LightOFF"
